...
(function () {
  ...
  // Hero headline cycling: rotates through all the ad-type nouns the
  // firm legalises, typewriter style (erase to empty, then type next).
  (function () {
    ...
    var words = [
      ...
      'фирмени надписи.',
      'билбордове.',
      'фирмено-информационно указателни табели.',
      'информационни пана.',
      'фирмени пана.'
    ];
    var ERASE_MS = 38;
